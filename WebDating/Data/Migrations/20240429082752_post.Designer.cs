...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("WebDating.Entities.AppRole", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("WebDating.Entities.Connection", b =>
                {
            ...
            modelBuilder.Entity("WebDating.Entities.ImagePost", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("WebDating.Entities.Photo", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("WebDating.Entities.Post", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasMaxLength(250)
            ...
            modelBuilder.Entity("WebDating.Entities.PostComment", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("WebDating.Entities.PostLike", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("WebDating.Entities.PostReportDetail", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("WebDating.Entities.PostSubComment", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("WebDating.Entities.Report", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityRoleClaim<int>", b =>
                {
                    b.HasOne("WebDating.Entities.AppRole", null)
                        .WithMany()
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<int>", b =>
                {
                    b.HasOne("WebDating.Entities.AppUser", null)
                        .WithMany()
            ...
            modelBuilder.Entity("WebDating.Entities.ImagePost", b =>
                {
                    b.HasOne("WebDating.Entities.Post", "Post")
                        .WithMany("Images")
            ...
            modelBuilder.Entity("WebDating.Entities.Message", b =>
                {
                    b.HasOne("WebDating.Entities.AppUser", "Recipient")
                        .WithMany("MessagesReceived")
                        .HasForeignKey("RecipientId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("WebDating.Entities.AppUser", "Sender")
            ...
            modelBuilder.Entity("WebDating.Entities.Photo", b =>
                {
                    b.HasOne("WebDating.Entities.AppUser", "AppUser")
                        .WithMany("Photos")
            ...
            modelBuilder.Entity("WebDating.Entities.PostReportDetail", b =>
                {
                    ...
                    b.HasOne("WebDating.Entities.Report", "Report")
                        .WithMany("PostReportDetails")
            ...
            modelBuilder.Entity("WebDating.Entities.PostSubComment", b =>
                {
                    b.HasOne("WebDating.Entities.PostComment", "PreComment")
            ...
            modelBuilder.Entity("WebDating.Entities.UserLike", b =>
                {
                    b.HasOne("WebDating.Entities.AppUser", "SourceUser")
                        .WithMany("LikedUsers")
                        .HasForeignKey("SourceUserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("WebDating.Entities.AppUser", "TargetUser")
